...
## Digital Divide
- I have been interested in the digital divide since supporting the 5G and Baltimore study (see below).  The urban digital divide has proved pernicious, long-standing, deeply entrenched, and pre-covid, easy for businesses and government to ignore. My home page reviews the research theory, gaps, and plan.  Via the 2 funded projects (begun March 2023) I am executing a community-led, digital equity mapping research and advocacy training project in adjacent-to-umd neighborhoods in Prince George’s County, MD.   The project is working with community leaders and UMD students to co-develop and deploy a bilingual (Spanish and English) broadband access survey to gather mapping data on: (1) residential service gaps; (2) reasons why service gaps exist; (3) adoption of direct-to-consumer benefit programs; and (4) if service is present, a measure of quality per upload/download speed test.
- A digital access map will be developed from the collected data as the foundation for future targeted investments in local neighborhoods.  The trainees will also curate materials on direct-to-consumer resources including the Affordable Connectivity Program, state, and county resources to convey this information to interested community members.  The survey deployment, mapping and advocacy work will take place each year for 3 years. New data avenues will be solicited/sourced to layer onto the map to elucidate further detail on the 5 friction points.  This data will be solicited from (when we can get it!): (a) State of Maryland speed test data; (b) public school and library systems who stepped in during Covid-19 with hot-spots and hardware; (c) ISP proprietary data for the study areas.  In years 2-3, survey distribution methodologies will be varied/tested (including the use of broadcast social media).
- **[preview the online survey](https://umdsurvey.umd.edu/jfe/preview/previewId/674d2b04-8b28-461b-a8e2-a59abf11aa13/SV_5dpFNRn1O5g4E5M?Q_CHL=preview&Q_SurveyVersionID=current)**
- **[take the demo speed test](https://go.umd.edu/speed-demo)**
